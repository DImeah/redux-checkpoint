...
const AddTask = () => {
  ...
  // Local state for input value and filtering flag
  const [value, setValue] = React.useState("");
  const [filtering, setFiltering] = React.useState(true);

  // Update the local state with user input
  ...
  // Filter tasks based on completed/pending
  ...
  // Set initial value when editing a task
  React.useEffect(() => {
    setValue(taskEditing.description || " ");
  }, [taskEditing.id]);

  // Save edited task to local storage and reset filters
